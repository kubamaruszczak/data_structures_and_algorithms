...
def merge_sort(linked_list: LinkedList):
    ...
    - Recursively device the linked list into sublists containing a single node
...
def merge(left: LinkedList, right: LinkedList):
    ...
    while left_head or right_head:
        ...
        # Add the tail node form left to merged linked list
            ...
            if left_data < right_data:
                ...
                left_head = left_head.next_node
            # If data on left is grater or equal to right, set current to right node
            else:
                current.next_node = right_head
    ...
    # Discard fake head and set first merger node as head
